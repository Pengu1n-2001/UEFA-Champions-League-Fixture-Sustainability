...
input_file_path = '../../Teams/Qualification Rounds/League Path Round 2/league_path_round_2_teams.csv'
output_file_path = '../../Teams/Qualification Rounds/League Path Round 3/league_path_round_3_teams.csv'
