...
input_file_path = '../../Teams/Qualification Rounds/Champions Path Round 3/champions_path_round_3_teams.csv'
output_file_path = '../../Teams/Qualification Rounds/Champions Path Play-off Round/champions_path_play_off_round_teams.csv'
