...
data = response.json()
with open('../Teams/Qualification Rounds/updated_uefa_coefficients.json', 'w', encoding='UTF-8') as file:
    json.dump(data, file, indent=4, ensure_ascii=False)
df = pd.read_csv('../Teams/Qualification Rounds/champions_path_round_1_potential_teams.csv')
with open('../Teams/Qualification Rounds/updated_uefa_coefficients.json', 'r', encoding='utf-8') as f:
    json_text = f.read()
...
df.to_csv('Qualification Rounds/champions_path_round_1_potential_teams.csv', index=False)