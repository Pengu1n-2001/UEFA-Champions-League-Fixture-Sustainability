...
league_stage_file_path = '../../Fixtures, Tables, Stats and Results/League Stage/league_stage_fixtures.csv'
knockout_stage_file_path = '../../Fixtures, Tables, Stats and Results/Knockout Stage/knockout_stage_results.csv'
output_file_path = '../../Fixtures, Tables, Stats and Results/Stats/Fixtures for Distance Calculation/league_stage_and_poko_fixtures.csv'
