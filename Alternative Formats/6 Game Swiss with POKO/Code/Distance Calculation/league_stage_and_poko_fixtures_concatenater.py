...
league_stage_file_path = '../../Fixtures/league_stage_fixtures.csv'
knockout_stage_file_path = '../../Fixtures/knockout_stage_results.csv'
output_file_path = '../../Fixtures/league_stage_and_poko_fixtures.csv'
