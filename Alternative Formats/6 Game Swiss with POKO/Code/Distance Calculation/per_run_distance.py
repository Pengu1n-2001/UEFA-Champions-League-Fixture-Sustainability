...
# Main program
team_stats_file = "../../Stats/team_stats.csv"
fixtures_distances_file = "../../Fixtures/league_stage_and_poko_fixtures_distances.csv"
output_file = "../../Stats/run_distance_analysis.csv"
